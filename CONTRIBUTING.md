...
1. 从最新默认分支创建短生命周期分支。
2. 保持每个提交范围清晰，Pull Request 标题使用 Conventional Commits 格式，例如 `feat: ...` 或 `fix: ...`；项目使用 squash merge 时，PR 标题会成为版本自动化读取的提交信息。
...
版本增量规则及 GitHub 自动发布设置见[自动发布指南](docs/RELEASING.md)。
